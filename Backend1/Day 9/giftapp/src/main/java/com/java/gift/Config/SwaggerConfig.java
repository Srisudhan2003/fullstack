...
public class SwaggerConfig {
    ...
    @Value("${gift.swagger.contact.name}")
    private String name;

    @Value("${gift.swagger.contact.email}")
    private String email;

    @Value("${gift.swagger.contact.url}")
    private String url;
    ...
    public OpenAPI openAPI(){
        ...
        .title("Craftify")
        .description("Craftify is a gift customization online store")
        .version("1.0.0")
        .contact(new Contact()
                .name(name)
                .email(email)
